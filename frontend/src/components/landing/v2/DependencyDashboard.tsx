    ...
    <section data-reveal className="border-t border-black/[0.07] py-[90px]">
      <div className="grid items-center gap-10 lg:grid-cols-[1fr_520px] lg:gap-16">
        <div>
          ...
          <p className="max-w-[46ch] text-[14.5px] leading-[1.6] text-[rgba(8,9,10,.55)]">
        ...
        <div className="relative overflow-hidden rounded-[14px] border border-black/[0.09] shadow-[0_24px_60px_-28px_rgba(0,0,0,.6)]">
