...
export function ProblemSection() {
  return (
    <section data-scroll-problem className="section-light px-6 py-[120px]">
      <div className="mx-auto max-w-[1080px]">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
          <div data-scroll-sticky-left className="lg:self-start">
            <div data-scroll-reveal>
              <p className="section-kicker">
                <span className="kicker-index">01</span> The problem
              </p>
              <h2 className="mt-5 max-w-[420px] text-section-mobile font-medium text-dl-text lg:text-section">
                AI writes the code now. Nobody&apos;s watching it as closely.
              </h2>
              <p className="mt-6 max-w-[400px] text-[15px] leading-relaxed text-dl-muted">
          ...
          <div data-scroll-reveal-group className="flex flex-col divide-y divide-dl-border border-t border-dl-border lg:border-t-0">
            {ROWS.map(({ index, title, copy }) => (
              <div key={index} className="grid grid-cols-[auto_1fr] gap-6 py-7 first:pt-0 lg:first:pt-0">
