            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="p-5 flex flex-col gap-4">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 rounded-xl bg-dl-navy text-white dark:bg-dl-blue py-2.5 text-[13px] font-semibold transition-all hover:opacity-90 disabled:opacity-50"
                >
