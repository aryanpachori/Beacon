...
export function PublicNav() {
  ...
  return (
    <nav className="public-nav relative z-[5] flex w-full items-center gap-5 border-b-2 border-black/[0.09] py-[26px] md:gap-9">
      <Link href="/" className="public-nav-brand mr-auto flex items-center gap-[11px]">
        ...
        <span className="text-[19px] font-semibold tracking-[-0.02em] text-[#08090a]">beacon</span>
      </Link>
      ...
      <Link
        href="/register"
        className="public-nav-cta rounded-full bg-[#08090a] px-4 py-[9px] text-[14px] font-medium transition-colors hover:opacity-90"
      >
        Install Beacon
      </Link>
    </nav>
