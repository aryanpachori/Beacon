          ...
          return (
            <div key={profile.handle} className="overflow-hidden rounded-2xl border border-dl-border bg-dl-bg p-4">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#ff6600] to-[#e55c00] text-[14px] font-bold text-white">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="flex items-center gap-1 font-mono text-[11px] text-dl-muted hover:text-[#ff6600] transition-colors"
                  >
