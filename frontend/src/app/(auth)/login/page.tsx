      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1.5 text-[14px] text-dl-muted">
            {redirectTo
              ? 'Sign in to continue'
              : 'Your AI Security Engineer is standing by.'}
          </p>
        </div>
          ...
          >
            ...
            <div>
              ...
              {errorCode === 'USER_NOT_FOUND' && (
                <Link href={registerHref} className="mt-1 inline-flex items-center gap-1 font-semibold text-[#ff6600] hover:underline">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              className={cn(
                ...
                emailTouched && emailError
                  ...
                  : emailTouched && !emailError && email
                    ...
                    : 'border-[rgba(255,255,255,0.12)] focus:border-[#ff6600] focus:ring-2 focus:ring-[#ff6600]/15'
              )}
              autoComplete="email"
            />
          ...
          <button
            ...
            disabled={loading}
            className={cn(
              'mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-[#ff6600] py-3 text-[14px] font-semibold text-[#0b0a08] shadow-sm transition-all duration-150',
        ...
        <p className="mt-4 text-center text-[13px] text-dl-muted">
          No account?{' '}
          <Link href={registerHref} className="font-semibold text-[#ff6600] hover:underline">
            Create one for free
          </Link>
        </p>
      </div>
