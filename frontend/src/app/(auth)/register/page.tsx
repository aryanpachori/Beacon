    ...
    <div className="min-h-screen bg-dl-bg flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="rounded-xl border border-dl-border bg-dl-surface p-6">
          <h1 className="text-base font-bold text-dl-text mb-1">Create your account</h1>
          <p className="text-xs text-dl-muted mb-5">Start monitoring your dependency health.</p>

          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div>
              <label className="block text-xs text-dl-muted mb-1">Name</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-xs text-dl-muted mb-1">Work email</label>
              <input
                type="email"
                value={email}
        ...
        <p className="text-center text-xs text-dl-muted mt-4">
          ...
          <Link href="/login" className="text-dl-text hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
